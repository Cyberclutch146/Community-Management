  ...
  return (
    <div className="flex items-center justify-between px-10 py-4 bg-[#f0eee9] rounded-full mx-6 mt-4">
      ...
      <div className="flex gap-8 text-sm">
        ...
        <button
          className={`pb-1 border-b-2 ${pathname.startsWith('/messages') ? 'border-[#1f3d2b]' : 'border-transparent opacity-60'} hover:opacity-100 active:scale-95 transition-all duration-200 ease-out`}
        >
          Messages
        </button>
      </div>
